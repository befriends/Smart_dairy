...
<html >
  ...
  <body>
    ...
    <div class="body"></div>
		...
		<br>
		<div class="login">
                    <form action="validateLogin" method="Post" name="login_form" style="color: orangered; background: url("images/LoginCow.jpg")">
				...
				<input type="password" placeholder="password" name="password" style="color: red;"><br>
                                <input type="button" name="Login" value="Login" style="color: white; background:blueviolet">
